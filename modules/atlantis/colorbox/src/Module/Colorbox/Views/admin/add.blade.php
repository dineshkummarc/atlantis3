...
<main>
  <section class="greeting">
    <div class="row">
      <div class="columns ">
        <h1 class="huge page-title">Add Item</h1>
        @if (isset($msgInfo))
  ...
  <section class="editscreen">
    {!! Form::open(['url' => 'admin/modules/colorbox/add', 'data-abide' => '', 'novalidate'=> '']) !!}
    <div class="row">
      <div class="columns">
      ...
      <div class="columns small-12">
        <ul class="tabs" data-tabs id="example-tabs">
          <li class="tabs-title is-active main">
            ...
            <a href="#panel1" aria-selected="true">New Item</a>
          </li>
        </ul>
                ...
                <div class="row">
                  ...
                  @if ($errors->get('gallery_id'))
                    <label for="gallery_id" class="is-invalid-label"><span class="form-error is-visible">{{ $errors->get('gallery_id')[0] }}</span>               
                      {!! Form::select('gallery_id', $aGalleries, NULL, ['id' => 'gallery_id']) !!} 
                    </label>
                    @else
                     <label for="gallery_id">Galleries <span class="form-error">- please create and select gallery first.</span>
                      {!! Form::select('gallery_id', $aGalleries, NULL, ['id' => 'gallery_id', 'required'=>'required']) !!} 
                    </label>
                    @endif
                  </div>                  
                </div>
