@extends('atlantis-admin::admin-shell')
  ...
  <section class="greeting">
    <div class="row">
      <div class="columns ">        
        <h1 class="huge page-title">Colorbox</h1>
        @if (isset($msgInfo))
      ...
      <div class="columns small-12">
        <ul class="tabs" data-tabs id="example-tabs">
          ...
          <li class="float-right list-filter">
            ...
            <a id="save-close-btn" class="alert button" href="/admin/modules/colorbox/add">New</a>
          </li>	
        </ul>
        <div class="tabs-content" data-tabs-content="example-tabs">
          <div class="tabs-panel is-active" id="panel1">
            {!! DataTable::set(\Module\Colorbox\Controllers\Admin\ColorboxDataTable::class) !!}
          </div>
