...
<main>
  <section class="greeting">
    <div class="row">
      <div class="columns ">        
        <h1 class="huge page-title">OpenGraph</h1>
        @if (isset($msgInfo))
      ...
      <div class="columns small-12">
        ...
        <div class="tabs-content" data-tabs-content="example-tabs">
          <div class="tabs-panel is-active" id="panel1">
            ...
            <code>
              \Atlantis\Helpers\Assets::registerContentWithKey('opengraph', [<br>
              'type' => 'website',<br>
              'title' => 'test title',<br>
              'description' => 'test description',<br>
              'url' => 'http://ogp.me/',<br>
              'site_name' => 'Test site name',<br>
              'image' => url(\Tools::getFilePath() . '1466441055-dog-in-snow_phone.jpg'),<br>
              'author' => 'Atlantis CMS'<br>
              ]);
            </code>
          </div>
