...
<main>
  <section class="greeting">
    <div class="row">
      <div class="columns ">
        <h1 class="huge page-title">Edit Form</h1>
        @if (isset($msgInfo))
  ...
  <section class="editscreen">
    {!! Form::open(array('url' => '/admin/modules/forms/edit/' . $oModel->id, 'data-abide' => '', 'novalidate'=> '')) !!}
    <div class="row">
      <div class="columns">
      ...
      <div class="columns small-12">
        <ul class="tabs" data-tabs id="example-tabs">
          <li class="tabs-title is-active main">
            ...
            <a href="#panel1" aria-selected="true">{{ $oModel->name }}</a>
          </li>
        </ul>
                ...
                <div class="row">
                  <div class="columns medium-4">
                    ...
                    <label for="name" class="is-invalid-label"><span class="form-error is-visible">{{ $errors->get('name')[0] }}</span>
                      ...
                      {!! Form::input('text', 'name', old('name', $oModel->name), ['class' => 'is-invalid-input', 'id'=>'name']) !!}
                    </label>
                    @else
                    <label for="name">Form Name <span class="form-error">is required.</span>
                      <span class="icon icon-Help top" data-tooltip title="This will be used to identify the Menu."></span>
                      {!! Form::input('text', 'name', old('name', $oModel->name), ['id'=>'name', 'required'=>'required']) !!}
                    </label>
                    @endif
                  </div>
                  <div class="columns medium-4">
                    <label for="form_class">Form Class
                      {!! Form::input('text', 'form_class', old('form_class', $oModel->form_class), ['id'=>'form_class']) !!}
                    </label>                    
                  </div>
                  <div class="columns medium-4">
                    <label for="btn_value">Submit button name <span class="form-error">is required.</span>
                      {!! Form::input('text', 'btn_value', old('btn_value', $oModel->btn_value), ['id' => 'btn_value', 'required'=>'required']) !!}
                    </label>                    
                  </div>
                  <div class="columns medium-4">
                    <label for="btn_class">Button class
                      {!! Form::input('text', 'btn_class', old('btn_class', $oModel->btn_class), ['id' => 'btn_class']) !!}
                    </label>                    
                  </div>
                  <div class="columns medium-4">
                        ...
                        <li class="row-item" id="row_items_{!! $item['weight']['value'] !!}">
                          <div class="callout">
                            <div class="row menu-item">
                              ...
                              <div class="columns">
                                <div class="row advanced" data-length="1" id="advanced-item{!! $item['weight']['value'] !!}" data-toggler=".expanded">
                                  <br>
                  ...
                  <div class="columns">                  
                    <label for="use_custom_form">Use Custom Template                      
                      <div class="switch tiny">
                        {!! Form::checkbox('use_custom_form', 1, $oModel->use_custom_form, ['class' => 'switch-input', 'id' => 'use_custom_form']) !!}
                  ...
                  <div class="columns">
                    <label for="custom_form">Custom template
                      {!! \Editor::set('custom_form', old('custom_form', $oModel->custom_form), ['rows' => 15, 'id' => 'custom_form']) !!}
                    </label>
                    <hr>
                  </div>
                  <div class="columns medium-4">
                    <label for="email_check">Should this form email its results?                      
                      <div class="switch tiny">
                        {!! Form::checkbox('email_check', 1, $oModel->email_check, ['class' => 'switch-input', 'id' => 'email_check']) !!}
                  ...
                  <div class="columns medium-4 end">
                    <label for="emails">Form Email Recipients, Comma Separated
                      {!! Form::input('text', 'emails', old('emails', $oModel->emails), ['id' => 'emails']) !!}
                    </label>                    
                  </div>
                </div>
              </div>
                  ...
                  <ul class="accordion" data-accordion>
                    ...
                    <li class="accordion-item" data-accordion-item>
                      ...
                      <div class="accordion-content" data-tab-content>
                        ...
                        <div class="switch tiny">
                          {!! Form::checkbox('ga', 1, $oModel->ga, ['class' => 'switch-input', 'id' => 'gaSwitch']) !!}
                      ...
                      <div class="accordion-content" data-tab-content>
                        <div class="row">
                          <div class="columns small-6">
                            ...
                            <div class="switch tiny">
                              {!! Form::checkbox('captcha', 1, $oModel->captcha, ['class' => 'switch-input', 'id' => 'captchaSwitch']) !!}
                          ...
                          <div class="columns small-6">
                            ...
                            {!! Form::select('select_captcha', $aCaptcha, $oModel->select_captcha, ['id' => 'select_captcha']) !!}
                          </div>
                        </div>
                      </div>
                    </li>
                    <li class="accordion-item" data-accordion-item>
                      ...
                      <div class="accordion-content" data-tab-content>                        
                        {!! Form::textarea('before_form_text', old('before_form_text', $oModel->before_form_text), ['rows' => 5, 'id'=>'before_form_text']) !!}
                      </div>
                    </li>
                    <li class="accordion-item" data-accordion-item>
                      <a href="#" class="accordion-title">After form text</a>
                      <div class="accordion-content" data-tab-content>                        
                        {!! Form::textarea('after_form_text', old('after_form_text', $oModel->after_form_text), ['rows' => 5, 'id'=>'after_form_text']) !!}
                      </div>
                    </li>                   
                  </ul>
                </aside>
