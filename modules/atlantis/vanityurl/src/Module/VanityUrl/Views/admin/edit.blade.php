...
<main>
  <section class="greeting">
    <div class="row">
      <div class="columns ">
        <h1 class="huge page-title">Edit Url</h1>
        @if (isset($msgInfo))
  ...
  <section class="editscreen">
    {!! Form::open(['url' => 'admin/modules/vanityurl/edit/' . $model->id, 'data-abide' => '', 'novalidate'=> '']) !!}
    <div class="row">
      <div class="columns">
      ...
      <div class="columns small-12">
        <ul class="tabs" data-tabs id="example-tabs">
          <li class="tabs-title is-active main">
            ...
            <a href="#panel1" aria-selected="true">Edit Vanity Url</a>
          </li>
        </ul>
                ...
                <div class="row">
                  <div class="columns medium-4">
                    ...
                    <label for="source_url" class="is-invalid-label"><span class="form-error is-visible">{{ $errors->get('source_url')[0] }}</span>
                      {!! Form::input('text', 'source_url', old('source_url', $model->source_url), ['class' => 'is-invalid-input', 'id'=>'source_url']) !!}
                    </label>
                    @else
                    <label for="source_url">Source URL <span class="form-error">is required.</span>
                      {!! Form::input('text', 'source_url', old('source_url', $model->source_url), ['id'=>'source_url', 'required'=>'required']) !!}
                    </label>
                    @endif
                  </div>
                  <div class="columns medium-4 end">
                    ...
                    <label for="dest_url" class="is-invalid-label"><span class="form-error is-visible">{{ $errors->get('dest_url')[0] }}</span>
                      {!! Form::input('text', 'dest_url', old('dest_url', $model->dest_url), ['class' => 'is-invalid-input', 'id'=>'dest_url']) !!}
                    </label>
                    @else
                    <label for="dest_url">Destination URL <span class="form-error">is required.</span>
                      {!! Form::input('text', 'dest_url', old('dest_url', $model->dest_url), ['id'=>'dest_url', 'required'=>'required']) !!}
                    </label>
                    @endif
                  </div>                                   
                </div>
